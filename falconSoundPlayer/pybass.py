...
BASS_ChannelGetAttribute = func_type(
    ctypes.c_bool, ctypes.c_ulong, ctypes.c_ulong, ctypes.POINTER(
        ctypes.c_float))(
...
if __name__ == "__main__":
    ...
    if not BASS_Init(-1, 44100, 0, 0, 0):
        ...
        if not BASS_GetInfo(bi):
            ...
            print(
                'number of free sample slots in the hardware = %d' %
                bi.freesam)
            print(
                'number of free 3D sample slots in the hardware = %d' %
                bi.free3d)
            print(
                'min sample rate supported by the hardware = %d' %
                bi.minrate)
            print(
                'max sample rate supported by the hardware = %d' %
                bi.maxrate)
            print(
